...
public class Constants {
	...
	final public static String ORIGINAL = "/" + RssConstants.LIBRARY_MAPPING_PREFIX + "/" + Rss.class.getSimpleName().toLowerCase() + "/";
	final public static String SHORTENED = "/" + Rss.class.getSimpleName().toLowerCase() + "/";
